    ...
    def init_products(self):
        ...
        if cursor.fetchone()[0] == 0:
            products = [
                ...
                # Памятники
                ("Памятник стандарт", "Стандартный гранитный памятник", 30000, "monument", "photos/monument1.jpg"),
                ("Памятник эксклюзив", "Индивидуальный дизайн", 60000, "monument", "photos/monument2.jpg"),

                # Надгробия
                ("Надгробие мраморное", "Мраморное надгробие", 20000, "tombstone", "photos/tombstone1.jpg"),

                # Ограды
                ("Ограда металлическая", "Металлическая ограда", 15000, "fence", "photos/fence1.jpg"),
            ]
